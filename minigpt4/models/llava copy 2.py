...
class LLaVa(BaseModel):
    ...
    def generate(
        ...
        with self.maybe_autocast():
            ...
            output_ids   = self.llama_model.generate( ##jadd_summary_tokens,add_image_related_tokens,add_pos_length
                input_ids=input_ids,
        ...
        return output_text#, len(output_token_ids), add_summary_tokens, add_image_related_tokens,add_pos_length  #, jsd_output_tokens,attention_layer_dict#, output_ids[:, input_token_len:].tolist()
